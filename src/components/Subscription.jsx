          ...
          <div className="container">
            ...
            <div className="flex flex-wrap justify-center -mx-4">
             ...
             "
                ...
                "
                  >
                    Perfect for people who visits shows occasionally
                  </p>
                  <div className="mb-7">
                ...
                text-center
                p-4
                hover:text-white hover:bg-pink-300 hover:border-primary
                transition
                "
                  >
                    Choose Personal
             ...
             "
                ...
                "
                  >
                    Perfect for couple and if you want to get yourself
                  ...
                  <div className="mb-7">
                    ...
                    <p className="text-base text-body-color leading-loose mb-1">
                      Priority and Early Entrance
                    </p>
                    <p className="text-base text-body-color leading-loose mb-1">
                      Free Drinks
                    </p>
                    <p className="text-base text-body-color leading-loose mb-1">
                      4 Free tickets Each Month
                    </p>
                    <p className="text-base text-body-color leading-loose mb-1">
                      Online Support
                    </p>
             ...
             "
                ...
                "
                  >
                    Perfect for a family who loves to enjoy events and gets
                    Entertained
                  </p>
                  <div className="mb-7">
                    <p className="text-base text-body-color leading-loose mb-1">
                    ...
                    <p className="text-base text-body-color leading-loose mb-1">
                      All Benefits of Personal and Premium
                    </p>
                    <p className="text-base text-body-color leading-loose mb-1">
                      VIP Access with 10 Free tickets of your choosing
                    </p>
                    <p className="text-base text-body-color leading-loose mb-1">
